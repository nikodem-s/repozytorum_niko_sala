...
INSERT INTO ksiegowosc.pracownicy values(14,'Magda','Gran','Zagórnik 48','664567957');

INSERT INTO ksiegowosc.godziny values(1,'2021-04-13',170,10);
INSERT INTO ksiegowosc.godziny values(2,'2021-04-13',160,9);
INSERT INTO ksiegowosc.godziny values(3,'2021-04-13',162,7);
INSERT INTO ksiegowosc.godziny values(4,'2021-04-13',164,6);
...
INSERT INTO ksiegowosc.godziny values(8,'2021-04-13',160,1);
...
INSERT INTO ksiegowosc.premie values(11,'brak',0);
...
INSERT INTO ksiegowosc.wynagrodzenia values(4,'2021-04-13',4,4,4,11);
INSERT INTO ksiegowosc.wynagrodzenia values(5,'2021-04-13',5,5,5,5);
INSERT INTO ksiegowosc.wynagrodzenia values(6,'2021-04-13',6,6,6,11);
...
INSERT INTO ksiegowosc.wynagrodzenia values(9,'2021-04-13',9,9,9,11);
...
SET telefon = LEFT(telefon,3) + '-' + RIGHT(telefon,6) 

UPDATE ksiegowosc.pracownicy
SET telefon = LEFT(telefon,7) + '-' + RIGHT(telefon,3);

SELECT * FROM ksiegowosc.pracownicy;
--dlugosc nazwiska
SELECT id_pracownika,imie,UPPER(nazwisko),adres,telefon FROM ksiegowosc.pracownicy WHERE LEN(nazwisko) = (select max(LEN(nazwisko)) from ksiegowosc.pracownicy);

--md5
SELECT HASHBYTES('MD5',imie)as IMIE,HASHBYTES('MD5',nazwisko)as NAZIWSKO,HASHBYTES('MD5',adres)as ADRES,HASHBYTES('MD5',telefon) as TELEFON,
HashBytes('MD5',CONVERT(VARCHAR(30),ksiegowosc.pensje.kwota)) as WYPLATA 
FROM ksiegowosc.pracownicy,ksiegowosc.wynagrodzenia,ksiegowosc.pensje WHERE
...
--SELECT CONVERT(MONEY,ksiegowosc.pensje.kwota) +200 FROM ksiegowosc.pensje;
--g
SELECT 'Pracownik '+ ksiegowosc.pracownicy.imie + ' ' + ksiegowosc.pracownicy.nazwisko + ' w dniu ' + 
CONVERT(VARCHAR(30),ksiegowosc.wynagrodzenia.daata) + ' otrzymal pensje calkowita na kwote '
+ CONVERT(VARCHAR(30),ksiegowosc.premie.kwota + ksiegowosc.pensje.kwota) + ', gdzie wynagrodzenie zasadnicze wynosilo: ' +
CONVERT(VARCHAR(30),ksiegowosc.pensje.kwota) + ', premia: ' + CONVERT(VARCHAR(30),ksiegowosc.premie.kwota) + ', nadgodziny: ' +
CONVERT(VARCHAR(30),(liczba_godzin-160) * 20) + ' z³' as RAPORT

FROM ksiegowosc.pracownicy,ksiegowosc.pensje,ksiegowosc.premie,ksiegowosc.wynagrodzenia,ksiegowosc.godziny
WHERE ksiegowosc.pracownicy.id_pracownika = ksiegowosc.wynagrodzenia.id_pracownika AND
ksiegowosc.premie.id_premii = ksiegowosc.wynagrodzenia.id_premii AND
ksiegowosc.pensje.id_pensji = ksiegowosc.wynagrodzenia.id_pensji AND
ksiegowosc.godziny.id_godziny = ksiegowosc.wynagrodzenia.id_godziny;